...
export default function DashboardView() {
  ...
  return (
    <div className="space-y-6 pb-8">
      ...
      <div className="p-5 flex flex-col md:flex-row items-center justify-between gap-4 bg-gradient-to-r from-emerald-800 via-emerald-700 to-teal-800 text-white rounded-xl shadow-md border border-emerald-600/40 relative overflow-hidden">
        <div className="relative z-10">
          <h2 className="text-lg font-bold text-white tracking-tight flex items-center gap-2">
            On-Demand Driver & Valet Operations Control
          </h2>
        ...
        <div className="flex items-center gap-2 w-full md:w-auto relative z-10">
          {/* <button
            ...
            className="flex-1 md:flex-initial px-3.5 py-2 bg-white hover:bg-emerald-50 text-emerald-900 rounded-lg text-xs font-bold shadow-xs flex items-center justify-center gap-1.5 transition-all"
          >
            <Radio className="w-4 h-4 text-emerald-600 animate-pulse" />
            <span>Driver Dispatch ({searchingDriverBookings.length})</span>
          </button> */}
          {/* <button
            onClick={() => setActiveTab('valet-bookings')}
            className="flex-1 md:flex-initial px-3.5 py-2 bg-slate-900 hover:bg-slate-800 text-white rounded-lg text-xs font-bold shadow-xs flex items-center justify-center gap-1.5 transition-all"
          >
            <Building2 className="w-4 h-4 text-amber-400" />
            <span>Valet Events ({pendingValetEvents.length})</span>
          </button> */}
        </div>
      </div>
