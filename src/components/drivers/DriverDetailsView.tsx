    ...
    <div className="space-y-6 pb-10 max-w-7xl mx-auto">
          ...
          <div className="relative">
            ...
            <span
              className={`absolute bottom-0 right-0 w-4 h-4 rounded-full border-2 border-white ${
                driver.dutyStatus === 'Online' ? 'bg-emerald-500' : 'bg-slate-400'
              }`}
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
        <div className="card-white p-4">
          <span className="text-[10.5px] font-bold uppercase tracking-wider text-slate-400">Total Bookings Received</span>
        ...
        <div className="card-white p-4">
          <span className="text-[10.5px] font-bold uppercase tracking-wider text-slate-400">Successfully Completed</span>
        ...
        <div className="card-white p-4">
          <span className="text-[10.5px] font-bold uppercase tracking-wider text-slate-400">Cancelled / Missed</span>
        ...
        <div className="card-white p-4">
          <span className="text-[10.5px] font-bold uppercase tracking-wider text-slate-400">Net Earned Revenue</span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="card-white p-5 space-y-4 flex flex-col justify-between">
          <div className="space-y-4">
            <div className="flex items-center justify-between border-b border-stone-100 pb-3">
              <h3 className="font-bold text-slate-900 text-sm flex items-center gap-2">
                <Award className="w-4.5 h-4.5 text-amber-500" /> Subscription Pass Status
              </h3>
              <span
                className={`px-2 py-0.5 rounded text-[10px] font-bold ${
              ...
              <div className="space-y-3 text-xs">
                <div className="p-3.5 bg-emerald-50/70 border border-emerald-200 rounded-lg space-y-2">
                  <div className="flex justify-between items-center">
                    <span className="font-bold text-emerald-900 text-sm">{driver.subscription.planName}</span>
                  </div>
                  <div className="flex justify-between text-slate-600 text-[11px]">
                    <span>Valid From: {driver.subscription.startDate}</span>
                    <span>Expires: {driver.subscription.expiryDate}</span>
                  </div>
                  <div className="text-[11px] font-bold text-emerald-800 pt-1.5 border-t border-emerald-200">
                    Remaining: {driver.subscription.daysRemaining} days active validity
                  </div>
                </div>

                <div className="p-2.5 bg-stone-50 border border-stone-200 rounded text-[11px] space-y-1">
                  <div className="flex justify-between">
                    <span>Local City Trips:</span>
