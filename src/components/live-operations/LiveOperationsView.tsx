    ...
    },
    {
      ...
      render: (b) => (
        <button
          ...
          className="px-2.5 py-1 bg-primary text-white text-[10px] font-bold rounded shadow-xs hover:bg-primary-hover flex items-center gap-1 ml-auto whitespace-nowrap"
        >
    ...
    },
    {
      ...
      render: (d) => (
        <div className="flex items-center justify-end gap-1.5">
          <a
            href={`tel:${d.phone}`}
            className="px-2.5 py-1 bg-slate-100 hover:bg-slate-200 text-slate-800 text-[11px] font-bold rounded flex items-center gap-1 whitespace-nowrap"
          >
    ...
    <div className="space-y-6 pb-12">
      ...
      <div className="card-white p-4">
        <div className="grid grid-cols-2 sm:grid-cols-4 divide-y sm:divide-y-0 sm:divide-x divide-slate-100 gap-4 sm:gap-0">
          <div className="sm:px-4 flex items-center justify-between">
            <div>
              <span className="text-[10px] font-bold text-slate-500 uppercase block">Ongoing Driver Trips</span>
          ...
          <div className="sm:px-4 pt-3 sm:pt-0 flex items-center justify-between">
            <div>
              <span className="text-[10px] font-bold text-slate-500 uppercase block">Pending Dispatch</span>
          ...
          <div className="sm:px-4 pt-3 sm:pt-0 flex items-center justify-between">
            <div>
              <span className="text-[10px] font-bold text-slate-500 uppercase block">Drivers Duty Online</span>
              <span className="text-xl font-bold text-slate-900 mt-1 block">{onlineDrivers.length}</span>
              <span className="text-[10px] text-emerald-600 font-bold block">Active duty fleet</span>
            </div>
          ...
          <div className="sm:px-4 pt-3 sm:pt-0 flex items-center justify-between">
            <div>
              <span className="text-[10px] font-bold text-slate-500 uppercase block">Available Drivers</span>
      ...
      <div className="flex items-center gap-2 border-b border-slate-200 pb-3">
        <button
          ...
          className={`px-3.5 py-2 rounded-lg text-xs font-bold transition-all flex items-center gap-1.5 ${activeTabState === 'driver-trips'
        ...
        <button
          ...
          className={`px-3.5 py-2 rounded-lg text-xs font-bold transition-all flex items-center gap-1.5 ${activeTabState === 'online-drivers'
            ? 'bg-primary text-white shadow-xs'
            : 'bg-white text-slate-600 hover:bg-slate-100 border border-slate-200'
            }`}
        >
