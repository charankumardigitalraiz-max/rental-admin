          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-slate-50/80 border-b border-slate-200 text-[11px] font-bold text-slate-600 uppercase tracking-wider">
                <th className="py-3 px-5">Module Name & Category</th>
                <th className="py-3 px-4 text-center w-28">Read / View</th>
                <th className="py-3 px-4 text-center w-28">Create / Edit</th>
                <th className="py-3 px-4 text-center w-28">Delete</th>
                <th className="py-3 px-4 text-center w-28">Export CSV</th>
                <th className="py-3 px-4 text-center w-28">Approve</th>
                <th className="py-3 px-4 text-center w-28">Quick All</th>
              </tr>
            </thead>
                  ...
                  <tr key={perm.id} className="hover:bg-slate-50/50 transition-colors">
                    ...
                    <td className="py-3.5 px-4 text-center">
                      <button
                        ...
                        disabled={selectedRole.isSystem}
                        className={`text-[11px] font-bold px-2 py-1 rounded transition-all ${isAllGranted
                            ? 'text-rose-700 bg-rose-50 hover:bg-rose-100'
                            : 'text-primary bg-primary-light/60 hover:bg-primary-light'
